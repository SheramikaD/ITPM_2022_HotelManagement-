...
<%
    if (request.getParameter("submit") != null) {
        ...
        pst = conn.prepareStatement("insert into insert_salry_details (employee_id,emplyee_name,employee_designation,emplyee_etf,emplyee_basic_salary) values (?,?,?,?,?)");
                                ...
                                <div id="Form-advance" class="card card card-default scrollspy">
                                    <div class="card-content">
                                        ...
                                        <form method="POST" action="#">
                                            ...
                                            <div class="row">
                                                <div class="input-field col m6 s12">
                                                    <input id="employee_designation" name="employee_designation" type="text">
                                                    <label for="employee_designation">Employee Designation</label>
                                                </div>
                                                <div class="input-field col m6 s12">
                                                    <input id="emplyee_basic_salary" name="emplyee_basic_salary" type="text">
                                                    <label for="emplyee_basic_salary">Employee Basic Salary Amount</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col m6 s12">
                                                    <input id="emplyee_etf"  name="emplyee_etf" type="text">
